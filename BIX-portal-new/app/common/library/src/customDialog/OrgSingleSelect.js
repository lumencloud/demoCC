                    ...
                    this._pDialog = new Promise(function (resolve) {
                        ...
                        Fragment.load({
                            ...
                            oSaveButton.attachPress(function () {
                                ...
                                console.log(this._oSelectedData.org_type)
                                let sType;
                                if (this._oSelectedData.org_type === 4044) {
                                    sType = "전사"
                                } else if (this._oSelectedData.org_type === 6907) {
                                    sType = "본부"
                                } else if (this._oSelectedData.org_type === 1796) {
                                    sType = "부문"
                                } else {
                                    sType = "팀"
                                }
                                ...
                                this.getBindingSource().getBinding("value").getModel().oData["orgTypeCode"] = this._oSelectedData.org_type;
