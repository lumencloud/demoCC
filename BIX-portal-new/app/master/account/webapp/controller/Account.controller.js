sap.ui.define([
...
], (Controller, JSONModel, Fragment, NumberFormat, MessageToast, coreLib, Filter, FilterOperator, MessageBox, Token, Messaging,Modules) => {
    "use strict";
    ...
    return Controller.extend("bix.master.account.controller.Account", {
        ...
        onSearch: function (oEvent, sFlag) {
            ...
            } else if (sFlag === "start") { //처음 패턴매치할때 초기화
                this.getView().setModel(new JSONModel(), "searchModel");
