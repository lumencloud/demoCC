...
using rsp.opp_labor_view as rsp_opp_labor_view from '../view/opp_labor_view';
...
view wideview_view_temp as
    ...
    full outer join rsp_opp_labor_view as opp
        on(
