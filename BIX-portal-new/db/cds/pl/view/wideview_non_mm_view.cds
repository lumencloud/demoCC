...
using common.non_mm_filter_vier as common_non_mm_filter_vier from '../../common/view/non_mm_filter_view';

namespace pl;

view wideview_non_mm_view as
    select from (
        select pl.* from (
            select * from pl_wideview_view
        ) as pl
        inner join common_non_mm_filter_vier as non_mm
            on(
