...
entity sfdc_contract : managed {
    ...
    key year                   : String(4)           @title: '회계연도연도';
        month                  : String(2)           @title: '마감월 - SFDC 마감x, 연결 대상 실적 데이터의 마감월';
