    ...
    srv.on('get_actual_dt_org_oi', async (req) => {
            ...
            let sale_data =
                {
                    ...
                    "org_id": data.id,
                    "org_name": data.name,
                    "target_curr_y_value": Number((flat_target?.[`_${data.id}_${year}_dt_target_sale_amt`] ?? 0)),
                    ...
                    "actual_curr_ym_rate": Number((flat_target?.[`_${data.id}_${year}_dt_target_sale_amt`] ?? 0)) === 0 ? 0 : (flat_pl?.[`_${data.id}_${year}_sale_amount_sum`] ?? 0) / (Number((flat_target?.[`_${data.id}_${year}_dt_target_sale_amt`] ?? 0))*100000000),
        ...
        pl_data.forEach(data2=>{
            if(data2.year === year){
                ...
                total_data[0].sale_total_amount_sum += data2.sale_total_amount_sum;
            };
        });
        ...
        total_data[0].actual_last_ym_rate = (total_data[0]?.sale_total_amount_sum ?? 0) === 0 ? 0 : (total_data[0]?.actual_last_ym_value ?? 0) / (total_data[0]?.sale_total_amount_sum ?? 0);
        ...
        total_data[0].actual_ym_rate_gap = (total_data[0]?.actual_curr_ym_rate ?? 0) - (total_data[0]?.actual_last_ym_rate ?? 0);
