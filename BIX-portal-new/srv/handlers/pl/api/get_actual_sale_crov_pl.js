...
module.exports = (srv) => {
    srv.on('get_actual_sale_crov_pl', async (req) => {
        ...
        let o_data = {}
        let o_total = {
            sale_true: {"display_order": i_count,"org_nm":org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? org_col_nm_name : '합계',"crov_type": "신규","type": "매출"},
            margin_true: {"display_order": ++i_count,"org_nm":org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? org_col_nm_name : '합계',"crov_type": "신규","type": "마진"},
            margin_rate_true: {"display_order": ++i_count,"org_nm":org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? org_col_nm_name : '합계',"crov_type": "신규","type": "마진률"},
            sale_false: {"display_order": ++i_count,"org_nm":org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? org_col_nm_name : '합계',"crov_type": "이월","type": "매출"},
            margin_false: {"display_order": ++i_count,"org_nm":org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? org_col_nm_name : '합계',"crov_type": "이월","type": "마진"},
            margin_rate_false: {"display_order": ++i_count,"org_nm":org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? org_col_nm_name : '합계',"crov_type": "이월","type": "마진률"},
        }; 
