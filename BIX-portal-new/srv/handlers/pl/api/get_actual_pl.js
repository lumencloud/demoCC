...
module.exports = (srv) => {
    srv.on('get_actual_pl', async (req) => {
        ...
        const sale_data =
        {
            ...
            "target_last_y_value": last_target?.target_sale_amt ?? 0,
            "actual_curr_ym_value": pl_curr_y_row?.["sale_amount_sum"] ?? 0,
            "actual_last_ym_value": pl_last_y_row?.["sale_amount_sum"] ?? 0,
            "actual_curr_ym_rate": (curr_target?.target_sale_amt ?? 0) !== 0 ? (pl_curr_y_row?.["sale_amount_sum"] ?? 0) / (curr_target.target_sale_amt * 100000000) : 0,
        ...
        const margin_rate_data =
        {
            ...
            // "actual_last_ym_rate": (pl_last_y_row?.sale_total_amount_sum ?? 0) === 0 || (sale_data["actual_last_ym_value"] === 0) ? 0 : (margin_data["actual_last_ym_value"] / sale_data["actual_last_ym_value"])/((pl_last_y_row?.margin_total_amount_sum ?? 0)/(pl_last_y_row?.sale_total_amount_sum ?? 0)) // 작년1~마감월 마진률 / 작년1~12 마진률
        };
        ...
        const sga_data =
        {
            ...
            "actual_curr_ym_rate": (curr_target?.sga_target_amt ?? 0) === 0 ? 0 : (sga_curr_y_row?.["sga_amount_sum"] ?? 0) / (curr_target?.sga_target_amt * 100000000),
        ...
        const contribution_data =
        {
            ...
            "actual_curr_ym_rate": (curr_target?.target_cont_margin_amt ?? 0) === 0 ? 0 : (margin_data["actual_curr_ym_value"] - (sga_curr_y_row?.["sga_amount_sum"] ?? 0)) / ((curr_target?.target_cont_margin_amt ?? 0) * 100000000),
        ...
        const profit_data =
        {
            "display_order": 7,
            "type": "영업이익",
            "target_curr_y_value": curr_target?.profit_target_amt ?? 0,
            ...
            "actual_curr_ym_rate": (curr_target?.profit_target_amt ?? 0) === 0 ? 0 : ((contribution_data["actual_curr_ym_value"]) - (sga_exp_curr_y_row?.["sga_amount_sum"] ?? 0)) / (curr_target.profit_target_amt * 100000000),
            "actual_last_ym_rate": (((pl_last_y_row?.margin_total_amount_sum ?? 0) - (sga_last_y_row?.sga_total_amount_sum ?? 0)) - (sga_exp_last_y_row?.sga_total_amount_sum)) === 0 ? 0 : ((contribution_data["actual_last_ym_value"]) - (sga_exp_last_y_row?.["sga_amount_sum"] ?? 0)) / (((pl_last_y_row?.margin_total_amount_sum ?? 0) - (sga_last_y_row?.sga_total_amount_sum ?? 0)) - (sga_exp_last_y_row?.sga_total_amount_sum)) // 작년1~마감월 ((마진 - 사업sg&a)-전사sg&a) / 작년1~12 ((마진 - 사업sg&a)-전사sg&a)
        };
        ...
        const profit_rate_data =
        {
            "display_order": 8,
            "type": "영업이익률",
            "target_curr_y_value": (curr_target?.target_sale_amt ?? 0) === 0 ? 0 : (curr_target?.profit_target_amt ?? 0) / curr_target.target_sale_amt,
            ...
            "actual_curr_ym_rate": (curr_target?.target_sale_amt ?? 0) === 0 || (pl_curr_y_row?.["sale_amount_sum"] ?? 0) === 0 || (curr_target?.profit_target_amt ?? 0) === 0 ? 0 : (profit_data["actual_curr_ym_value"] / pl_curr_y_row?.["sale_amount_sum"]) / ((curr_target?.profit_target_amt ?? 0) / curr_target?.target_sale_amt),
