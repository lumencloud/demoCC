sap.ui.define([
    ...
    return Controller.extend("bix.card.sgaDetailTableAiReport.Main", {
        ...
        onCellClick: function (oEvent) {
            ...
            //합계 클릭 제거
            if (oRowData.div_nm === "합계" ) {
                this._excludeTotalRows = true;
            }

            //기타 좌클릭 우클릭 이벤트 제거  
            if (oRowData.div_nm === "기타" ) {
        ...
        onCellContextmenu: function (oEvent) {
            ...
            //팀단위 접근 방지
            if (Number(oSessionData.orgTypeCode) === 4044) {//전사
            ...
            } else if (Number(oSessionData.orgTypeCode) === 1796) {//부문
                this.singleRowAi = this._selectedOrgId;
            ...
            Module.setTableMerge(this.byId("table"), "sgaDetailTreeTableModel", 1);
        ...
        _callDataSgaTable: async function () {
            ...
            // let oSumLabor = {
            //     div_nm: sOrgLv !== 'hdqt_id' && sOrgLv !== 'team_id' ? '합계' : sOrgName,
            //     div_id: sOrgId,
            //     type: 'LABOR',
            ...
            //     //팀의 합계가 본부가 되어서
            //     aRes.forEach(item=>{
            //         item.div_nm = oAiData.singleRowAi_Nm
            //     })
            // }
        ...
        onFormatPerformance: function (iValue1, sTooltip) {
            ...
            if (iValue1 < 1000000 && iValue1 > 0) {
                if (sTooltip === "마진율" || sTooltip === "마진률" || sTooltip === "percent" || sTooltip === "tooltip") { }
