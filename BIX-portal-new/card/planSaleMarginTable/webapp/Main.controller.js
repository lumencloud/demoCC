sap.ui.define([
    ...
    return Controller.extend("bix.card.planSaleMarginTable.Main", {
        _aTableLists: ["planSaleMarginTable1", "planSaleMarginTable4", "planSaleMarginTable3", "planSaleMarginTable2"],
        _aBoxLists: ["planSaleMarginBox1", "planSaleMarginBox2", "planSaleMarginBox3", "planSaleMarginBox4"],
        ...
        _startAnalysis: function (oEvent, oParams, sAnalysisId) {
            ...
            const table_id = oEvent.getSource().getId();
            let func_nm;
            if (table_id === "planSaleMarginTable1") {
                func_nm = "get_forecast_pl_sale_margin_org_detail"
            }
            else if (table_id === "planSaleMarginTable2") {
                func_nm = "get_forecast_pl_sale_margin_account_detail"
            }
            else if (table_id === "planSaleMarginTable3") {
                func_nm = "get_forecast_pl_sale_margin_crov_detail"
            }
            else if (table_id === "planSaleMarginTable4") {
                func_nm = "get_forecast_pl_sale_margin_relsco_detail"
            }
