module.exports = (srv) => {
    srv.on('get_forecast_opp_br', async (req) => {
        ...
        const rsp_where_conditions = { 'year': year, 'biz_opp_no':{'!=':null, and : {'biz_opp_no': {'!=':''}}}, 'ccorg_cd':ccorg_cd };
        const rsp_groupBy_cols = ['ccorg_cd','biz_opp_no','prj_tp_nm'];
        
        const opp_col_list = ['biz_opp_nm','biz_opp_no'];
        const opp_where_conditions = {'biz_opp_nm':{'!=':null, and : {'biz_opp_nm': {'!=':''}}},'biz_opp_no':{'!=':null, and : {'biz_opp_no': {'!=':''}}}};
