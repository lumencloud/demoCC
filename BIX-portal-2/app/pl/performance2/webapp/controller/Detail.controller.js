...
], function (JSONModel, Controller, MessageToast, MessageBox, EventBus, AgentService, InteractionUtils, AiReport, Modules) {
    "use strict";
        ...
        _getEventBus: function (sChannelId, sEventId, oData) {
            ...
            if (sEventId === "detail") {
                ...
                oButton.firePress(function (oEvent) {
                    this.onPressMenuTitle(oEvent, oFirstMenu.detail_path);
                }.bind(this));
            }
        },
