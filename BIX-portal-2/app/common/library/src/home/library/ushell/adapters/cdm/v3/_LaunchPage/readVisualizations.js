...
sap.ui.define([
    ...
    readVisualizations.getTarget = function (oVisualization) {
        let oVizConfig = this.getConfig(oVisualization);
    ...
    readVisualizations.getAppId = function (oVisualization) {
        let oTarget = this.getTarget(oVisualization);
    ...
    readVisualizations.getKeywords = function (aCdmParts) {
        let aClonedCdmParts = deepClone(aCdmParts, 20); // do not modify input parameter
    ...
    readVisualizations.getDataSource = function (aCdmParts, sDataSourceId) {
        ...
        let oDataSources = utils.getNestedObjectProperty(
            aClonedCdmParts,
