...
entity project : managed {
    ...
    key prj_no            : String(20)    @title: '프로젝트 번호'              @description: 'PROMIS / ERP / PLATFORM';
        ...
        cstco_cd          : String(20)    @title: '고객사 코드(ERP)'          @description: 'PROMIS / ERP / PLATFORM';
        rodr_ccorg_cd     : String(20)    @title: '수주 조직 코드(cc_code)'    @description: 'PROMIS';
        sale_ccorg_cd     : String(20)    @title: '매출 조직 코드(cc_code)'    @description: 'PROMIS / ERP / PLATFORM';
