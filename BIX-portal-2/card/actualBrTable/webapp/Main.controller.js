sap.ui.define([
...
], function (Controller, JSONModel, Module, EventBus, ODataModel, NumberFormat) {
    "use strict";
    ...
    return Controller.extend("bix.card.actualBrTable.Main", {
        ...
        _setData:async function(sChannelId, sEventId, oData){
            this.byId("actualBrTable1").setBusy(true)
            ...
            let sOrgPath =`/get_actual_br_org_detail(year='${iYear}',org_id='${sOrgId}')`
           ...
           await Promise.all([
            ...
            this._setTableMerge();         
            this.byId("actualBrTable1").setBusy(false)
        ...
        onFormatPerformance: function (iValue, iValue2, sType, sType2) {
            ...
            } else if(sType2 === "limit"){
                if(iValue>1){
                    iValue = 1
                }
            }else if(sType2 === "purpose"){
                iValue=iValue*0.01;
            }
