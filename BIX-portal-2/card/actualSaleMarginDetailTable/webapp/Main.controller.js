sap.ui.define([
    ...
    return Controller.extend("bix.card.actualSaleMarginDetailTable.Main", {
        ...
        _setData: async function (sChannelId, sEventId, oData) {
            ...
            this.byId("actualSaleMarginDetailTable1")._bindingPath = sOrgPath;
            this.byId("actualSaleMarginDetailTable2")._bindingPath = sAccountPath;
            this.byId("actualSaleMarginDetailTable3")._bindingPath = sTernalPath;
            this.byId("actualSaleMarginDetailTable4")._bindingPath = sOverPath;
            this.byId("actualSaleMarginDetailTable5")._bindingPath = sOwnPath;
        ...
        onFormatPerformance: function (iValue, iValue2, sType, sType2) {
            ...
            // 억단위로 들어오는 데이터 사용 
            if (sType2 === "Billion") {
                if (sType !== "tooltip" && sType !== "마진율" && sType !== "마진률") {
                    iValue = iValue * 100000000
                }
            }

            // 단위 조정
            if (sType === "마진율" || sType === "마진률" ||sType === "percent") {
