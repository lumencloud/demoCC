...
entity if_wideview {
    ...
    key year            : Integer        @title: 'Fiscal Year';
    key month           : Integer        @title: 'Closing Month';
        biz_opp_no      : String(24)     @title: '사업기회번호';
    key prj_no          : String(20)     @title: '프로젝트 번호';
        biz_opp_desc    : String(40)     @title: '사업기회 Desc';
        prj_desc        : String(40)     @title: '프로젝트 Desc.';
        ...
        sale_ccorg_nm   : String(20)     @title: '매출조직 명';
