...
entity wideview : managed {
    ...
    key year             : Integer not null     @title: '회계연도';
    key month            : Integer not null     @title: '마감월';
    key ccorg_cd         : String(10) not null  @title: '외주비 귀속조직 코드';
    ...
    key prj_tp_nm        : String(20) not null  @title: '프로젝트 타입명'  @description: 'SI / OS / (DT) SI/OS 구분 프로젝트 타입을 보고 SI/OS를 넣음  (SI-MA, OT : OS로 / 프로젝트 타입 유형 : DT가 있음 별도 정리 必)';
        ...
        ito_total_amt : Decimal(18, 2)       @title: '총 외주비';
