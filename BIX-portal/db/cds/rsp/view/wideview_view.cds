    ...
    select from (
        ...
        from (
            select
                ...
                co_m11_amt,
                co_m12_amt,
                (case when to_integer(total_labor.month) < 1 then avg_m1_amt else 0 end +
                case when to_integer(total_labor.month) < 2 then avg_m2_amt else 0 end + 
                case when to_integer(total_labor.month) < 3 then avg_m3_amt else 0 end + 
                case when to_integer(total_labor.month) < 4 then avg_m4_amt else 0 end + 
                case when to_integer(total_labor.month) < 5 then avg_m5_amt else 0 end + 
                case when to_integer(total_labor.month) < 6 then avg_m6_amt else 0 end + 
                case when to_integer(total_labor.month) < 7 then avg_m7_amt else 0 end + 
                case when to_integer(total_labor.month) < 8 then avg_m8_amt else 0 end + 
                case when to_integer(total_labor.month) < 9 then avg_m9_amt else 0 end + 
                case when to_integer(total_labor.month) < 10 then avg_m10_amt else 0 end + 
                case when to_integer(total_labor.month) < 11 then avg_m11_amt else 0 end + 
                case when to_integer(total_labor.month) < 12 then avg_m12_amt else 0 end)  as est_avg_year_amt : Decimal(18, 2),

                (case when to_integer(total_labor.month) < 1 then total_m1_emp else 0 end +
                case when to_integer(total_labor.month) < 2 then total_m2_emp else 0 end + 
                case when to_integer(total_labor.month) < 3 then total_m3_emp else 0 end + 
                case when to_integer(total_labor.month) < 4 then total_m4_emp else 0 end + 
                case when to_integer(total_labor.month) < 5 then total_m5_emp else 0 end + 
                case when to_integer(total_labor.month) < 6 then total_m6_emp else 0 end + 
                case when to_integer(total_labor.month) < 7 then total_m7_emp else 0 end + 
                case when to_integer(total_labor.month) < 8 then total_m8_emp else 0 end + 
                case when to_integer(total_labor.month) < 9 then total_m9_emp else 0 end + 
                case when to_integer(total_labor.month) < 10 then total_m10_emp else 0 end + 
                case when to_integer(total_labor.month) < 11 then total_m11_emp else 0 end + 
                case when to_integer(total_labor.month) < 12 then total_m12_emp else 0 end)  as est_total_year_emp : Decimal(18, 2),

                (case when to_integer(total_labor.month) < 1 then total_m1_amt else 0 end +
                case when to_integer(total_labor.month) < 2 then total_m2_amt else 0 end + 
                case when to_integer(total_labor.month) < 3 then total_m3_amt else 0 end + 
                case when to_integer(total_labor.month) < 4 then total_m4_amt else 0 end + 
                case when to_integer(total_labor.month) < 5 then total_m5_amt else 0 end + 
                case when to_integer(total_labor.month) < 6 then total_m6_amt else 0 end + 
                case when to_integer(total_labor.month) < 7 then total_m7_amt else 0 end + 
                case when to_integer(total_labor.month) < 8 then total_m8_amt else 0 end + 
                case when to_integer(total_labor.month) < 9 then total_m9_amt else 0 end + 
                case when to_integer(total_labor.month) < 10 then total_m10_amt else 0 end + 
                case when to_integer(total_labor.month) < 11 then total_m11_amt else 0 end + 
                case when to_integer(total_labor.month) < 12 then total_m12_amt else 0 end)  as est_total_year_amt : Decimal(18, 2),
        ...
        full outer join (
            select
                ...
                (case when to_integer(month) < 1 then sum(opp_m1_amt) else 0 end +
                case when to_integer(month) < 2 then sum(opp_m2_amt) else 0 end + 
                case when to_integer(month) < 3 then sum(opp_m3_amt) else 0 end + 
                case when to_integer(month) < 4 then sum(opp_m4_amt) else 0 end + 
                case when to_integer(month) < 5 then sum(opp_m5_amt) else 0 end + 
                case when to_integer(month) < 6 then sum(opp_m6_amt) else 0 end + 
                case when to_integer(month) < 7 then sum(opp_m7_amt) else 0 end + 
                case when to_integer(month) < 8 then sum(opp_m8_amt) else 0 end + 
                case when to_integer(month) < 9 then sum(opp_m9_amt) else 0 end + 
                case when to_integer(month) < 10 then sum(opp_m10_amt) else 0 end + 
                case when to_integer(month) < 11 then sum(opp_m11_amt) else 0 end + 
                case when to_integer(month) < 12 then sum(opp_m12_amt) else 0 end)  as opp_year_amt : Decimal(18, 2)
