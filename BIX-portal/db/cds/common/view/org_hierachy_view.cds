...
view org_hierachy_view as
    select from (
        ...
        from (
            ...
            where
                type in (
                    select distinct org_lv1_type from org_type_hierachy_view
                )
        ) as lv1
        full outer join (
            select
            ...
            where
                    type in (
                    select distinct org_lv2_type from org_type_hierachy_view
                )
                and id   in (
                    select distinct org_lv2_id from org_type_hierachy_view
                )
        ) as lv2
        ...
        full outer join (
            ...
            where
                    type in (
                    select distinct org_lv3_type from org_type_hierachy_view
                )
                and id   in (
                    select distinct org_lv3_id from org_type_hierachy_view
                )
        ) as lv3
        ...
        full outer join (
            ...
            where
                type in (
                    select distinct org_lv4_type from org_type_hierachy_view
                )
        ) as lv4
        ...
        full outer join (
            ...
            where
                type in (
                    select distinct org_lv5_type from org_type_hierachy_view
                )
        ) as lv5
        ...
        full outer join (
            ...
            where
                type in (
                    select distinct org_lv6_type from org_type_hierachy_view
                )
        ) as lv6
...
view org_type_hierachy_view as
    select from (
        select distinct
