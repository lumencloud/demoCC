...
entity org_test : managed {
    ...
    key id         : String(20) not null @title: '조직 ID';
        ...
        sort_order : String(100)         @title: '정렬순서';
        str_dt     : String(10)          @title: '시작일';
        end_dt     : String(10)          @title: '종료일';
        use_yn     : Boolean             @title: '사용 여부';
        ccorg_cd   : String(8) not null  @title: 'ERP Cost Center';
        type       : String(10) not null @title: '조직 타입';
        Parent_org : Association to one org_test
                         on Parent_org.id = $self.parent;
        Child_org  : Association to many org_test
