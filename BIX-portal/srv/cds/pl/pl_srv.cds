...
service PL_Service {
     ...
     */
    function get_forecast_pl(year : String(4), org_id : String(10))                                                        returns array of oForecastRes;
    /**
     * [추정PL] OI 테이블 데이터 호출 API
     */
    function get_forecast_oi(year : String(4), org_id : String(10))                                                        returns array of oForecastRes;
     ...
     */
    function get_actual_m_pl(year : String(4), org_id : String(10))                                                        returns array of oMonthly;
    /**
