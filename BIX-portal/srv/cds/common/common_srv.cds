...
service ComService {
    ...
    view code_item_view(category : String(20)) as
        select from common_view.code_item_view (
            category: :category
        );
    ...
    view annual_target_temp_view(target_type: String(20)) as select from common_target_view.annual_target_temp_view(target_type: :target_type);
