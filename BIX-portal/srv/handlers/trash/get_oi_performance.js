module.exports = (srv) => {
    srv.on('get_oi_performance', async (req) => {
        ...
        const rsp_column = ['year', 'month_amt', 'sum(ifnull(total_amt_sum,0)) as total_amt_sum', 'sum(ifnull(bill_amt_sum,0)) as bill_amt_sum'];
        ...
        const br_data =
        {
            ...
            "performanceCurrentYearMonth": rsp_row['total_amt_sum'] !== 0 ? rsp_row['bill_amt_sum']/rsp_row['total_amt_sum']* 100:0,
            "performanceLastYearMonth": rsp_last_y_row['total_amt_sum'] !== 0 ? rsp_last_y_row['bill_amt_sum']/rsp_last_y_row['total_amt_sum']* 100:0,
            "performanceAttainmentRateCurrentYear": 0,
            "performanceAttainmentRateLastYear": 0
        };
        ...
        const rohc_data =
        {
            ...
            "type": "RoHC",
            "goal": 0,
            "performanceCurrentYearMonth": rsp_row['total_amt_sum'] !== 0 ? ((pl_row?.["margin_amount_sum"] || 0) - (sga_row?.["amount_sum"] || 0))/rsp_row['total_amt_sum']:0,
            "performanceLastYearMonth": rsp_last_y_row['total_amt_sum'] !== 0 ? ((pl_last_y_row?.["margin_amount_sum"] || 0) - (sga_last_y_row?.["amount_sum"] || 0))/rsp_last_y_row['total_amt_sum']:0,
            "performanceAttainmentRateCurrentYear": 0,
            "performanceAttainmentRateLastYear": 0
        };
