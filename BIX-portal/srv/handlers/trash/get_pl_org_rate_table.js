...
module.exports = (srv) => {
    srv.on('get_pl_org_rate_table', async (req) => {
        /**
         * 핸들러 초기에 권한체크
         */
        ...
        const pl_where_conditions = { 'year': { in: [year, last_year] }, 'month_amt': month};
         ...
         * SG&A 조회용 컬럼
         */
        const rsp_col_list = ['year', 'month_amt', 'sum(ifnull(total_year_amt,0)) as total_year_amt', 'sum(ifnull(bill_year_amt,0)) as bill_year_amt'];
