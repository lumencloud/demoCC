...
module.exports = (srv) => {
    srv.on('get_actual_sale_relsco_pl', async (req) => {
        try{
            ...
            const pl_col_list = ['year', 'relsco_yn', s_sale_column, s_margin_column];
            ...
            // DB 쿼리 실행 (병렬)
            let [pl_data, account_pl_data] = await Promise.all([
            ...
            if(orgInfo.org_level === 'lv1_id' || orgInfo.org_level === 'lv2_id'){
                ...
                let ackerton_curr_rel_t_sum_data = {
                ...
                let ackerton_curr_rel_f_sum_data = {
                    id: ackerton_org.org_id,
                    margin_amount_sum: 0,
                    name: ackerton_org.org_name,
                    relsco_yn: false,
                ...
                let ackerton_last_rel_t_sum_data = {
                    id: ackerton_org.org_id,
                    margin_amount_sum: 0,
                    name: ackerton_org.org_name,
                    relsco_yn: true,
                ...
                let ackerton_last_rel_f_sum_data = {
                    id: ackerton_org.org_id,
                    margin_amount_sum: 0,
                    name: ackerton_org.org_name,
                    relsco_yn: false,
                ...
                ackerton_data.forEach(data => {
                    if(data.year === year){
                        if(data.relsco_yn){
                            ackerton_curr_rel_t_sum_data.sale_amount_sum += data.sale_amount_sum;
                            ackerton_curr_rel_t_sum_data.margin_amount_sum += data.margin_amount_sum;
                        }else{
                            ackerton_curr_rel_f_sum_data.sale_amount_sum += data.sale_amount_sum;
                            ackerton_curr_rel_f_sum_data.margin_amount_sum += data.margin_amount_sum;
                        }
                    }else if(data.year === last_year){
                        if(data.relsco_yn){
                            ackerton_last_rel_t_sum_data.sale_amount_sum += data.sale_amount_sum;
                            ackerton_last_rel_t_sum_data.margin_amount_sum += data.margin_amount_sum;
                        }else{
                            ackerton_last_rel_f_sum_data.sale_amount_sum += data.sale_amount_sum;
                            ackerton_last_rel_f_sum_data.margin_amount_sum += data.margin_amount_sum;
                        }
                    }
                });
                pl_data = pl_data.filter(item=>!ac_map.includes(item['id']))
                pl_data.push(ackerton_curr_rel_t_sum_data);
                pl_data.push(ackerton_curr_rel_f_sum_data);
                pl_data.push(ackerton_last_rel_t_sum_data);
                pl_data.push(ackerton_last_rel_f_sum_data);
            };
            ...
            let o_data = {}
            let o_total = {
                sale_true: {"display_order": i_count,"org_name": org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? org_col_nm_name : '합계',"relsco_type": "대내","type": "매출"},
                // margin_true: {"display_order": ++i_count,"org_name": org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? org_col_nm_name : '합계',"relsco_type": "대내","type": "마진"},
                // margin_rate_true: {"display_order": ++i_count,"org_name": org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? org_col_nm_name : '합계',"relsco_type": "대내","type": "마진율"},
                sale_false: {"display_order": ++i_count,"org_name": org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? org_col_nm_name : '합계',"relsco_type": "대외","type": "매출"},
                // margin_false: {"display_order": ++i_count,"org_name": org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? org_col_nm_name : '합계',"relsco_type": "대외","type": "마진"},
                // margin_rate_false: {"display_order": ++i_count,"org_name": org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? org_col_nm_name : '합계',"relsco_type": "대외","type": "마진율"},
            }; 
