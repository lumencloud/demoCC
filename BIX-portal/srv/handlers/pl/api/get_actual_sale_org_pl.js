module.exports = (srv) => {
    srv.on('get_actual_sale_org_pl', async (req) => {
        ...
        let target_where = org_col_nm === 'lv1_id' ? target_where_conditions : {...target_where_conditions, [org_col_nm]: org_id, and:{[org_col_nm]:{'!=':null}}};
        ...
        let pl_where = org_col_nm === 'div_id' ? {...pl_where_conditions,'hdqt_id':{'!=':null},and:{[org_col_nm]: org_id}} : org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? {...pl_where_conditions,'team_id':{'!=':null},and:{[org_col_nm]: org_id}} : {...pl_where_conditions,and:{[org_col_nm]: org_id}};
