...
module.exports = (srv) => {
    srv.on('get_forecast_pl_sale_margin_crov_detail', async (req) => {
        try{
             ...
             */
            const crov_curr_t_pl = query.filter(pl => (pl.crov_div_yn || pl.crov_div_yn === null) && pl.year === year),
                    crov_curr_f_pl = query.filter(pl => pl.crov_div_yn === false && pl.year === year),
                    crov_last_t_pl = query.filter(pl => (pl.crov_div_yn || pl.crov_div_yn === null) && pl.year === last_year),
                    crov_last_f_pl = query.filter(pl => pl.crov_div_yn === false && pl.year === last_year);
            
            /**
             * 총합데이터
             */
            let o_total = {
                't_sale':{"display_order": 0, "item_order" : 1, "type1": "신규", "type2": "매출", "org_id":'total', "org_name" : org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? orgInfo.org_name : '합계'},
                't_margin':{"display_order": 0, "item_order" : 2, "type1": "신규", "type2": "마진", "org_id":'total', "org_name" : org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? orgInfo.org_name : '합계'},
                'f_sale':{"display_order": 0, "item_order" : 3, "type1": "이월", "type2": "매출", "org_id":'total', "org_name" : org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? orgInfo.org_name : '합계'},
                'f_margin':{"display_order": 0, "item_order" : 4, "type1": "이월", "type2": "마진", "org_id":'total', "org_name" : org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? orgInfo.org_name : '합계'}
            }
                ...
                if(['lv1_id','lv2_id'].includes(org_col_nm) && org.lv3_ccorg_cd === '610000'){
                    if(!o_result[`${org.lv3_ccorg_cd}_t_sale`]){
                        o_result[`${org.lv3_ccorg_cd}_t_sale`] = {
                            ...
                            "org_id" : org.lv3_id,
                            "secured_value":0,
                            "last_secured_value":0,
                            "forecast_value":0,
                            "last_forecast_value":0,
                            "yoy":0,
                            "not_secured_value":0,
                            "last_not_secured_value":0,
                        }
                        o_result[`${org.lv3_ccorg_cd}_t_margin`] = {
                            "display_order": org.org_order,
                            "item_order" : 2,
                            "type1": "신규",
                            "type2": "마진",
                        ...
                        o_result[`${org.lv3_ccorg_cd}_f_margin`] = {
                            "display_order": org.org_order,
                            "item_order" : 4,
                            "type1": "이월",
                            "type2": "마진",
                    ...
                    o_result[`${org.lv3_ccorg_cd}_t_sale`]['secured_value'] += o_crov_curr_t_pl?.secured_sale ?? 0
                    o_result[`${org.lv3_ccorg_cd}_t_margin`]['secured_value'] += o_crov_curr_t_pl?.secured_margin ?? 0
                    o_result[`${org.lv3_ccorg_cd}_f_sale`]['secured_value'] += o_crov_curr_f_pl?.secured_sale ?? 0
                    o_result[`${org.lv3_ccorg_cd}_f_margin`]['secured_value'] += o_crov_curr_f_pl?.secured_margin ?? 0
        
                    o_result[`${org.lv3_ccorg_cd}_t_sale`]['not_secured_value'] += o_crov_curr_t_pl?.not_secured_sale ?? 0
                    o_result[`${org.lv3_ccorg_cd}_t_margin`]['not_secured_value'] += o_crov_curr_t_pl?.not_secured_margin ?? 0
                    o_result[`${org.lv3_ccorg_cd}_f_sale`]['not_secured_value'] += o_crov_curr_f_pl?.not_secured_sale ?? 0
                    o_result[`${org.lv3_ccorg_cd}_f_margin`]['not_secured_value'] += o_crov_curr_f_pl?.not_secured_margin ?? 0
        
                    o_result[`${org.lv3_ccorg_cd}_t_sale`]['last_secured_value'] += o_crov_last_t_pl?.secured_sale ?? 0
                    o_result[`${org.lv3_ccorg_cd}_t_margin`]['last_secured_value'] += o_crov_last_t_pl?.secured_margin ?? 0
                    o_result[`${org.lv3_ccorg_cd}_f_sale`]['last_secured_value'] += o_crov_last_f_pl?.secured_sale ?? 0
                    o_result[`${org.lv3_ccorg_cd}_f_margin`]['last_secured_value'] += o_crov_last_f_pl?.secured_margin ?? 0
        
                    o_result[`${org.lv3_ccorg_cd}_t_sale`]['last_not_secured_value'] += o_crov_last_t_pl?.not_secured_sale ?? 0
                    o_result[`${org.lv3_ccorg_cd}_t_margin`]['last_not_secured_value'] += o_crov_last_t_pl?.not_secured_margin ?? 0
                    o_result[`${org.lv3_ccorg_cd}_f_sale`]['last_not_secured_value'] += o_crov_last_f_pl?.not_secured_sale ?? 0
                    o_result[`${org.lv3_ccorg_cd}_f_margin`]['last_not_secured_value'] += o_crov_last_f_pl?.not_secured_margin ?? 0
        
                    o_result[`${org.lv3_ccorg_cd}_t_sale`]['forecast_value'] += (o_crov_curr_t_pl?.secured_sale ?? 0) + (o_crov_curr_t_pl?.not_secured_sale ?? 0)
                    o_result[`${org.lv3_ccorg_cd}_t_margin`]['forecast_value'] += (o_crov_curr_t_pl?.secured_margin ?? 0) + (o_crov_curr_t_pl?.not_secured_margin ?? 0)
                    o_result[`${org.lv3_ccorg_cd}_f_sale`]['forecast_value'] += (o_crov_curr_f_pl?.secured_sale ?? 0) + (o_crov_curr_f_pl?.not_secured_sale ?? 0)
                    o_result[`${org.lv3_ccorg_cd}_f_margin`]['forecast_value'] += (o_crov_curr_f_pl?.secured_margin ?? 0) + (o_crov_curr_f_pl?.not_secured_margin ?? 0)
                    o_result[`${org.lv3_ccorg_cd}_t_sale`]['last_forecast_value'] += (o_crov_last_t_pl?.secured_sale ?? 0) + (o_crov_last_t_pl?.not_secured_sale ?? 0)
                    o_result[`${org.lv3_ccorg_cd}_t_margin`]['last_forecast_value'] += (o_crov_last_t_pl?.secured_margin ?? 0) + (o_crov_last_t_pl?.not_secured_margin ?? 0)
                    o_result[`${org.lv3_ccorg_cd}_f_sale`]['last_forecast_value'] += (o_crov_last_f_pl?.secured_sale ?? 0) + (o_crov_last_f_pl?.not_secured_sale ?? 0)
                    o_result[`${org.lv3_ccorg_cd}_f_margin`]['last_forecast_value'] += (o_crov_last_f_pl?.secured_margin ?? 0) + (o_crov_last_f_pl?.not_secured_margin ?? 0)
                    ...
                    o_result[`${org.lv3_ccorg_cd}_t_margin`]['yoy'] = o_result[`${org.lv3_ccorg_cd}_t_margin`]['forecast_value'] - o_result[`${org.lv3_ccorg_cd}_t_margin`]['last_forecast_value']
                    ...
                    o_result[`${org.lv3_ccorg_cd}_f_margin`]['yoy'] = o_result[`${org.lv3_ccorg_cd}_f_margin`]['forecast_value'] - o_result[`${org.lv3_ccorg_cd}_f_margin`]['last_forecast_value']
                }else{
