...
module.exports = (srv) => {
    srv.on('get_actual_sale_relsco_pl_total', async (req) => {
        try{
            ...
            let pl_where = org_col_nm === 'div_id' ? {...pl_where_conditions,'hdqt_id':{'!=':null},and:{[org_col_nm]: orgInfo.org_id}} : org_col_nm === 'hdqt_id' || org_col_nm === 'team_id' ? {...pl_where_conditions,'team_id':{'!=':null},and:{[org_col_nm]: orgInfo.org_id}} : {...pl_where_conditions,'div_id':{'!=':null},and:{[org_col_nm]: orgInfo.org_id}};
