sap.ui.define([
    ...
    return Controller.extend("bix.card.planPipelineDetailTable.Main", {
        ...
        _bindTable: async function (sChannelId, sEventId, oData) {
            ...
            let aBindingPath = [];
            aBindingPath.push(`/get_forecast_pl_pipeline_detail(year='${iYear}',month='${sMonth}',org_id='${sOrgId}',type='deal')`);
            aBindingPath.push(`/get_forecast_pl_pipeline_detail(year='${iYear}',month='${sMonth}',org_id='${sOrgId}',type='month')`);
            aBindingPath.push(`/get_forecast_pl_pipeline_detail(year='${iYear}',month='${sMonth}',org_id='${sOrgId}',type='rodr')`);
