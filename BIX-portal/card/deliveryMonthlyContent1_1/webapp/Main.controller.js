	...
	return Controller.extend("bix.card.deliveryMonthlyContent1_1.Main", {
		...
		_parseReportContent: function (content) {
			try {
				...
				return {
					title: "AI 보고서",
					//positive: "긍정요인을 분석 중입니다.",
					//negative: "부정요인을 분석 중입니다.",
					full: "AI 분석 진행 중 입니다."
				};
			}
		},
		...
		_parseTextToStructure: function (content) {
			...
			/*
			if (!reportData.positive) {
				reportData.positive = "긍정요인을 분석 중입니다.";
			}

			if (!reportData.negative) {
				reportData.negative = "부정요인을 분석 중입니다.";
			}
			*/
			return reportData;
		},
