sap.ui.define([
    ...
    "sap/m/MessageBox"
], function (Controller, JSONModel, Module, ODataModel, NumberFormat, EventBus, Modules, InteractionUtils, AgentService, AIPopupManager, MessageBox) {
    "use strict";
    ...
    return Controller.extend("bix.card.planBrTable.Main", {
        ...
        _bindTable: async function (sChannelId, sEventId, oData) {
            ...
            await Promise.all([
                ...
                Module.displayStatusForEmpty(this.byId("planBrTable1"),aResults[0].value, this.byId("planBrBox1"));
            ...
            .catch((oErr) => {
                Modules.displayStatus(this.byId("planBrTable1"),oErr.error.code, this.byId("planBrBox1"));
            });
            this._setTableMerge();
        ...
        _startAnalysis: function (oEvent, oParams, sAnalysisId) {
            ...
            InteractionUtils.handleTableInteraction(this, oEvent, table_id, {
                ...
                params: oParams,
                functionName: "get_forecast_br_org_detail"
            })
                .then((result) => {
        ...
        onFormatPerformance: function (iValue, sTooltip) {
            return Modules.valueFormat('BR', iValue, '', sTooltip)
        },
