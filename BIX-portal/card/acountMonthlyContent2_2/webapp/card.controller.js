...
sap.ui.define([
    ...
    return Controller.extend("bix.card.acountMonthlyContent2_2.card", {
        ...
        _updateChart: async function () {
            ...
            this._oMyChart[0].data.datasets[1].data = aResults.aRodr
            this._oMyChart[0].data.datasets[2].data = aResults.aEmpty
            this._oMyChart[0].data.datasets[3].data = aResults.aSales
                                ...
                                datalabels:{
                                    ...
                                    formatter: function(value, context){
                                            if(context.dataset.label === '수주'){
                                                ...
                                                value = context.chart.data.datasets[3].data[context.dataIndex]
                                            }
