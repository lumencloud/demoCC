sap.ui.define(
  ...
  function (BaseController, EventBus, ODataModel, JSONModel, NumberFormat, Module) {
    "use strict";
    return BaseController.extend("bix.card.negotiationStageBau.card", {
      ...
      _dataSetting: async function (oEvent, sEventId) {
        ...
        let sPath = oData ? `/ai_agent_bau_view4(start_date='${oData.start_date}',end_date=${oData.end_date})/Set` :
          `/ai_agent_bau_view4(start_date='${monday}',end_date=${sunday})/Set`
      ...
      _modelSetting: function (aResult) {
        ...
        this._oEventBus.publish("aiReport", "negoBauData", oModel)
