sap.ui.define([
    ...
    "../../main/util/Module",
    "sap/m/MessageToast",
], function (Controller, JSONModel, ODataModel, EventBus, Modules, InteractionUtils, AgentService, AIPopupManager, HashChanger, Module, MessageToast) {
    "use strict";
    ...
    return Controller.extend("bix.card.actualDTSalesTableAiReport.Main", {
        ...
        _bindTable: async function (sChannelId, sEventId, oData) {
            ...
            await Promise.all([
                ...
                // account일 때 매출만 필터링
                if (sKey === "account") {
                    aResults[0].value = aResults[0].value.filter(oData => oData.type === "매출");
                }
