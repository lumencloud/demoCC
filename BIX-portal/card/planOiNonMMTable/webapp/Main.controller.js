sap.ui.define([
    ...
    return Controller.extend("bix.card.planOiNonMMTable.Main", {
        _aTableLists:["planOiNonMMTable1", "planOiNonMMTable2"],
        _aBoxLists:["planOiNonMMBox1", "planOiNonMMBox2"],
        ...
        _bindTable: async function (sChannelId, sEventId, oData) {
            ...
            let sAccountPath = `/get_forecast_non_mm_account_oi(year='${iYear}',month='${sMonth}',org_id='${sOrgId}')`
            let sLobPath = `/get_forecast_non_mm_lob_oi(year='${iYear}',month='${sMonth}',org_id='${sOrgId}')`
        ...
        _setTableMerge:function(){
            let oTable1 = this.byId("planOiNonMMTable1")
            let oTable2 = this.byId("planOiNonMMTable2")
