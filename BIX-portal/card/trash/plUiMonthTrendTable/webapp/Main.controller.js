...
sap.ui.define([
    ...
    return Controller.extend("bix.card.plUiMonthTrendTable.Main", {
        _sTableId: "plUiMonthTrendTable",
        ...
        _bindTable: async function () {
            ...
            // 테이블 바인딩
            let sPath = `/get_actual_m_pl(year='${iYear}',org_id='${sOrgId}')`
