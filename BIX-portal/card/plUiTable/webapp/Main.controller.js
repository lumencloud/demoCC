...
sap.ui.define([
...
], function (Controller, JSONModel, NumberFormat, Sorter, ODataModel, Fragment, EventBus, InteractionUtils) {
    "use strict";
    ...
    return Controller.extend("bix.card.plUiTable.Main", {
        ...
        onFormatPerformance: function (sType, iValue1, iValue2, sTooltip) {
            ...
            const formatFunc = function (sType, iNewValue) {
            ...
            let NewValue = (iValue2 && !isNaN(iValue2)) ? (iValue1 - iValue2) : iValue1;

            // if(iValue2 && !isNaN(iValue2)){

            //     return formatFunc(sType,iValue2)+ " (" + formatFunc(sType,NewValue) + ")";
            // } else {

            return formatFunc(sType, NewValue);
            // }
        },
