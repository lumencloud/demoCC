...
sap.ui.define([
    ...
    return Controller.extend("bix.card.plGrid1.Main", {
        ...
        _setChartData: function (aResults, aLabels) {
            ...
            if(!isNaN(aChartData6[aChartData6.length-1]) && !isNaN(aChartData6[aChartData6.length-2])){
                let iChk = aChartData6[aChartData6.length-1] - aChartData6[aChartData6.length-2];
                let oIcon = this.byId("plGrid6ChartIcon");
                if(iChk > 0){
