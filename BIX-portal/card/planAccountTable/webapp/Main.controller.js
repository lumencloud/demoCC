    ...
    return Controller.extend("bix.card.planAccountTable.Main", {
        ...
        _bindTable: async function (sChannelId, sEventId, oData) {
            ...
            await Promise.all([
                ...
                Module.displayStatusForEmpty(this.byId("planAccountTable1"),aResults[0].value, this.byId("planAccountBox1"));
                Module.displayStatusForEmpty(this.byId("planAccountTable2"),aResults[1].value, this.byId("planAccountBox2"));
                Module.displayStatusForEmpty(this.byId("planAccountTable3"),aResults[2].value, this.byId("planAccountBox3"));
            ...
            .catch((oErr) => {
                Modules.displayStatus(this.byId("planAccountTable1"),oErr.error.code, this.byId("planAccountBox1"));
                Modules.displayStatus(this.byId("planAccountTable2"),oErr.error.code, this.byId("planAccountBox2"));
                Modules.displayStatus(this.byId("planAccountTable3"),oErr.error.code, this.byId("planAccountBox3"));
            });
        },
        ...
        onCellContextmenu: function (oEvent) {
            ...
            sessionStorage.setItem("aiModel",
                JSON.stringify({
                    ...
                    aiSubTitle: oSelectedItem.getText(),
