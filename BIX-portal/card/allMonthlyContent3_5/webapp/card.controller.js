...
sap.ui.define([
    ...
    return Controller.extend("bix.card.allMonthlyContent3_5.card", {
        _aCanvasId: [],
        _aContainerId: [],
    ...
    _dataSetting: async function () {
        ...
        let aTake = [
            aResults[0].order["more10bil"],
            aResults[0].order["5bil_10bil"],
            aResults[0].order["3bil_5bil"],
            aResults[0].order["1bil_3bil"],
            aResults[0].order["500mil_1bil"],
            aResults[0].order["100mil_500mil"],
            aResults[0].order["less100mil"]
        ];
        let aSale = [
            aResults[0].sale["more10bil"],
            aResults[0].sale["5bil_10bil"],
            aResults[0].sale["3bil_5bil"],
            aResults[0].sale["1bil_3bil"],
            aResults[0].sale["500mil_1bil"],
            aResults[0].sale["100mil_500mil"],
            aResults[0].sale["less100mil"]
        ];
        let aChance = [
            aResults[0].cnt["more10bil"],
            aResults[0].cnt["5bil_10bil"],
            aResults[0].cnt["3bil_5bil"],
            aResults[0].cnt["1bil_3bil"],
            aResults[0].cnt["500mil_1bil"],
            aResults[0].cnt["100mil_500mil"],
            aResults[0].cnt["less100mil"]
        ];
    ...
    _setData: async function () {
        ...
        let sOrgPath = `/get_ai_forecast_rodr_pipeline(year='${iYear}',month='${sMonth}',org_id='${sOrgId}',org_tp='${sType}')`
