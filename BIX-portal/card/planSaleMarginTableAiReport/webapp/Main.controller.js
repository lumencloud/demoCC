sap.ui.define([
    ...
    "sap/m/MessageToast",
], function (Controller, JSONModel, Module, ODataModel, EventBus, Modules, InteractionUtils, AgentService, AIPopupManager, HashChanger, MessageToast) {
    "use strict";
     ...
     */
    return Controller.extend("bix.card.planSaleMarginTableAiReport.Main", {
        /**
        ...
        onCellClick: function (oEvent) {
            ...
            //합계 클릭 금지 
            if (oRowData.org_name === "합계" || oRowData.account_nm === "합계" || oRowData.org_id === "total") {
