...
sap.ui.define([
    ...
    objectOperations.getMember = function (oObject, sAccessPath) {
        let oPathSegments = sAccessPath.split("."),
            oNextObject = oObject;
        if (!oObject) {
            return undefined;
        }
    ...
    objectOperations.getNestedObjectProperty = function (aObjects, oAccessPath, oDefault) {
        ...
        let MISSING_OR_INVALID_PARAMETER = "Missing or invalid parameter";
        ...
        let oNestedObjectProperty = aObjects.reduce(function (oMatch, oObject, iIndex) {
            if (oMatch !== undefined) {
                return oMatch;
            }
