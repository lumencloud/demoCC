sap.ui.define([
...
], (Controller, JSONModel, MessageToast, Filter, FilterOperator, Module, OrgSingleSelect, EventBus) => {
    "use strict";
    ...
    return Controller.extend("bix.master.project.controller.Project", {
        ...
        onMyRoutePatternMatched: async function () {
            ...
            // 테이블 데이터 바인딩
            this.byId("searchButton").firePress();
        ...
        _setModel: async function () {
            ...
            const oBinding = this.getOwnerComponent().getModel().bindContext("/org");
