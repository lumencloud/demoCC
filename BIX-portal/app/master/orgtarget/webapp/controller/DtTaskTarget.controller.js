    ...
    return Controller.extend("bix.master.orgtarget.controller.DtTaskTarget", {
                    ...
                    if(oProperty.value === 'A02'){
                        oText = new Text({
                            text:{
                                ...
                                formatter: function (iSale, iMargin) {
                                    ...
                                    let iFormatNumber1 = !iSale || !iMargin ? '0%' : oNumberFormat.format(Math.floor(iMargin / iSale * 10000) / 10000);
        ...
        _setData: async function (oEvent, sEventId, oData) {
            if(!sEventId || oData.type === "DT과제별"){
                ...
                // 데이터 호출
                let sPlUrl = "/get_type_target(type='task')";
