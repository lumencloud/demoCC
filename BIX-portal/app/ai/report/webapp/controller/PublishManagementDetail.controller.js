sap.ui.define([
    ...
    function (
        ...
        return Controller.extend("bix.ai.report.controller.PublishManagementDetail", {
            onInit: function () {
                _this = this;
                this._globalVarSet();
            ...
            onMyRoutePatternMatched: async function (oEvent) {
                ...
                let oPublishModel = this.getOwnerComponent().getModel("publish");

                let sDashBoardPath = `/ai_set('${MenuSeq}')`;
                ...
                let sContentPath = `/get_ai_content(dashboard_id='${MenuSeq}')`;
            ...
            onPDF: async function () {
                let oPdfObject = document.querySelector(".workPage");

                new html2canvas(oPdfObject, { scale: 2 }).then((canvas) => {
