sap.ui.define([
    ...
    "sap/ui/Device",
    "bix/admin/publish/model/models",
    'sap/ui/model/json/JSONModel',
    "bix/common/library/control/Modules",
    "sap/base/util/ObjectPath",
    "sap/base/Log",
],
    function (UIComponent, Device, models, JSONModel, Modules, ObjectPath, Log) {
        "use strict";

        return UIComponent.extend("bix.admin.publish.Component", {
            metadata: {
                manifest: "json",
                events: {
                    workPageEdited: {},
