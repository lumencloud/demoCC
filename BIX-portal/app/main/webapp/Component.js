sap.ui.define([
    ...
    return UIComponent.extend("bix.main.Component", {
        ...
        getMenuInfo() {
            const oHomeConfig = [{
                "ID": "home",
                "i18nTitle_i18nKey": "menu_home",
                "sortOrder": 0,
                "iconSrc": "sap-icon://bbyd-dashboard"
            }];
        ...
        _setRoutingConfig(oMenuData) {
            ...
            if (Array.isArray(oMenuData)) {
                for (const oMenu of oMenuData) {
                    if (oMenu.ID !== 'home') {
                        this._setManfestInfo(oMenu);
                        for (const oChildMenu of oMenu.Child) {
                            this._setManfestInfo(oChildMenu);
                        }
                    };
                }
            }
                ...
                oRouter.getTargets().addTarget(sTargetName,
                    {
                        ...
                        "title": `{i18n>${oMenu.i18nTitle_i18nKey}}`,
                        "id": sNestedCompName,
