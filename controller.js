    ...
    function (
        ...
        return Controller.extend("bix.ai.list.controller.MainMonthly", {
            ...
            onInit: function () {
                ...
                // if (sap.ui.core.routing.HashChanger.getInstance().getHash().indexOf("MainMonthly") !== -1) {
            ...
            _changeApiPath: function (oData, year, month) {
                ...
                const aFirstPagePaths = [
                    { deliContent1_2: "/get_actual_m_pl_oi" + `(year='${year}',month='${month}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` },
                    { deliContent1_3: "/get_actual_m_rate_gap_pl_oi" + `(year='${year}',month='${month}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` }
                ]
                // 나머지 페이지 api path
                const aRestPagePaths = [
                    { allContent2_1: "/get_actual_m_account_sale_pl" + `(year='${year}',month='${month}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` },
                    { allContent2_2: "/get_actual_m_sale_org_pl" + `(year='${year}',month='${month}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` },
                    { allContent3_4: "/get_ai_forecast_deal_pipeline" + `(year='${year}',month='${month}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` },
                    { allContent3_5: "/get_ai_forecast_rodr_pipeline" + `(year='${year}',month='${month}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` },
                    { deliContent2_1: "/get_actual_m_sale_org_pl" + `(year='${year}',month='${month}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` },
                    { deliContent2_2: "/get_actual_m_br_org_detail" + `(year='${year}',month='${month}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` },
                    { deliContent2_3: "/get_actual_m_rohc_org_oi" + `(year='${year}',month='${month}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` },
                    { deliContent2_4: "/get_actual_m_sga" + `(year='${year}',month='${month}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` },
                    { deliContent3_1: "/get_ai_forecast_pl" + `(year='${year}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` },
                    { deliContent3_3: "/get_ai_forecast_m_pl" + `(year='${year}',month='${month}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` },
                    { accountContent2_2: "/get_actual_m_sale_rodr_org_pl" + `(year='${year}',month='${month}',org_id='${oData.org_id}',org_tp='${oData.org_tp}')` },
                ]
                // 네 번째 페이지 표 형태 카드 api path
                const aTablePagePath = [
                    { nego: "/get_ai_forecast_deal_type_pl" + `(year='${year}',month='${month}',org_id='${oData.org_id}',deal_stage_cd='nego',org_tp='${oData.org_tp}')` },
                    { lost: "/get_ai_forecast_deal_type_pl" + `(year='${year}',month='${month}',org_id='${oData.org_id}',deal_stage_cd='lost',org_tp='${oData.org_tp}')` },
                    { new: "/get_ai_forecast_deal_type_pl" + `(year='${year}',month='${month}',org_id='${oData.org_id}',deal_stage_cd='new',org_tp='${oData.org_tp}')` },
                    { qualified: "/get_ai_forecast_deal_type_pl" + `(year='${year}',month='${month}',org_id='${oData.org_id}',deal_stage_cd='qualified',org_tp='${oData.org_tp}')` },
                    { contract: "/get_ai_forecast_deal_type_pl" + `(year='${year}',month='${month}',org_id='${oData.org_id}',deal_stage_cd='contract',org_tp='${oData.org_tp}')` }
                ]
            ...
            _onCardReady: function (sChannelId, sEventId, oData) {
                ...
                if (this._iCardReady === this.iCardCount) {
                    ...
                    // this.byId("pdfDownload").setBusy(false);
